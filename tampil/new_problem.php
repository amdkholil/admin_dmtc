	...
	<div class="col-sm-12">
		<form method="post" action="proses/proses.php" class="form-horizontal fieldset">
			<div class="form-group">
				<label class="col-sm-2">Jenis Masalah</label>
				<div class="col-sm-4">
					<input type="text" name="problem_name" class="form-control input-sm" required>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2"></label>
				<div class="col-sm-6">
					<input type="submit" value="Simpan" name="problem" class="btn btn-sm btn-primary"> &nbsp; 
